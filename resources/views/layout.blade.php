...
<head>
    ...
    <link href="{{ asset('https://larapoultry.herokuapp.com/admin/vendor/fontawesome-free/css/all.min.css')}}" type="text/css" rel="stylesheet">
    ...
    <link href="{{ asset('https://larapoultry.herokuapp.com/admin/css/sb-admin-2.min.css')}}" rel="stylesheet">
