...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="{{ asset('https://larapoultry.herokuapp.com/admin/vendor/fontawesome-free/css/all.min.css')}}">
    ...
    <link rel="stylesheet" href="{{ asset('https://larapoultry.herokuapp.com/admin/css/sb-admin-2.min.css')}}">
