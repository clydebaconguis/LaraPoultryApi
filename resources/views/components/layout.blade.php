...
<body id="page-top">
    <div id="wrapper">
                        ...
                        <ul class="navbar-nav ml-auto">
                                ...
                                <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                    ...
                                    <a class="dropdown-item d-flex align-items-center" href="#">
                                        <div class="dropdown-list-image mr-3">
                                            <img class="rounded-circle" src="{{asset('css/assets/img/undraw_profile_1.svg')}}"
                                                alt="...">
                                    ...
                                    <a class="dropdown-item d-flex align-items-center" href="#">
                                        <div class="dropdown-list-image mr-3">
                                            <img class="rounded-circle" src="{{asset('css/assets/img/undraw_profile_2.svg')}}"
                                                alt="...">
                                    ...
                                    <a class="dropdown-item d-flex align-items-center" href="#">
                                        <div class="dropdown-list-image mr-3">
                                            <img class="rounded-circle" src="{{asset('css/assets/img/undraw_profile_3.svg')}}"
                                                alt="...">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <span id="admin-title" class="mr-2 d-none d-lg-inline text-gray-600 small">Admin</span>
        ...
        <!-- Page level plugins -->
        <script src="{{asset('css/assets/vendor/chart.js/Chart.min.js')}}"></script>

        <!-- Page level custom scripts -->
        <script src="{{asset('css/assets/js/demo/chart-area-demo.js')}}"></script>
        <script src="{{asset('css/assets/demo/chart-pie-demo.js')}}"></script>

        <!-- Page level plugins -->
        <script src="{{asset('css/assets/vendor/datatables/jquery.dataTables.min.js')}}"></script>
        <script src="{{asset('css/assets/vendor/datatables/dataTables.bootstrap4.min.js')}}"></script>
